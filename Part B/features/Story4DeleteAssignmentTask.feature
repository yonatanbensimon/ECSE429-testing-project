Feature: Deleting a completed assignment
    ...
    Scenario: Delete a completed assignment (Normal Flow)
        When a student deletes an assignment task with title A1
        Then the assignment task with title A1 is deleted

    Scenario: Delete an incomplete assignment after completing it (Alternate Flow)
        When a student completes assignment A2
        And a student deletes an assignment task with title A2
        Then the assignment task with title A2 is deleted
